...
$lieu_slug = 'vieille_chambre_du_petit_garon';
                ...
                <div class='card-body'>
                    ...
                    <?php else: ?>
                        ...
                        <div class='enigme-content'>
                            ...
                            <p class='lead'>Quelle est la bonne attitude face aux emails suspects ?</p>
                            
                            <div class='options mt-4'>
                                <div class='form-check mb-3'>
                                    <input class='form-check-input' type='radio' name='answer' id='option1' value='A'>
                                    <label class='form-check-label' for='option1'>
                                        <strong>A)</strong> Ne pas ouvrir et signaler comme spam
                                    </label>
                                </div>
                                ...
                                <div class='form-check mb-3'>
                                    ...
                                    <label class='form-check-label' for='option2'>
                                        <strong>B)</strong> Ouvrir pour voir ce que c'est
                                    </label>
                                </div>
                                ...
                                <div class='form-check mb-3'>
                                    ...
                                    <label class='form-check-label' for='option3'>
                                        <strong>C)</strong> Répondre pour demander plus d'infos
                                    </label>
                                </div>
                                ...
                                <div class='form-check mb-3'>
                                    ...
                                    <label class='form-check-label' for='option4'>
                                        <strong>D)</strong> Partager avec ses collègues
                                    </label>
                                </div>
                            </div>
...
function updateParcoursStatus(success) {
    fetch('../../update_parcours_status.php', {
        ...
        body: JSON.stringify({
            lieu: 'vieille_chambre_du_petit_garon',
