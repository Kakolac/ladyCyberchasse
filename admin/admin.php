...
?>
        ...
        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card tool-card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="text-muted">Créer, modifier et gérer les équipes participantes</p>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#equipesModal">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card tool-card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <h5>Gestion des Parcours</h5>
                                        <p class="text-muted">Configurer et suivre les parcours des équipes</p>
                                        <a href="parcours.php" class="btn btn-success">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card tool-card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="text-muted">Administrer les lieux et énigmes du jeu</p>
                                        <a href="lieux.php" class="btn btn-warning">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card tool-card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <h5>Génération QR Codes</h5>
                                        <p class="text-muted">Créer les QR codes pour les équipes</p>
                                        <a href="generate_qr.php" class="btn btn-info">
            ...
            <!-- Activités récentes -->
            <div class="col-md-4">
                <div class="card admin-card" id="activites">
                    <div class="card-header bg-info text-white">
                        <h5><i class="fas fa-history"></i> Activités Récentes</h5>
                    </div>
                    <div class="card-body">
                        <?php if (isset($dernieresActivites) && !empty($dernieresActivites)): ?>
                            <?php foreach ($dernieresActivites as $activite): ?>
                                <div class="activity-item <?php echo $activite['statut'] === 'active' ? 'success' : ($activite['statut'] === 'pending' ? 'warning' : 'danger'); ?>">
                                    <strong><?php echo htmlspecialchars($activite['equipe_nom']); ?></strong>
                                    <br>
                                    <small class="text-muted">
                                        <?php echo htmlspecialchars($activite['lieu_nom']); ?> - 
                ...
                <div class="card admin-card mt-3">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button class="btn btn-outline-primary" onclick="resetAllGames()">
                                <i class="fas fa-redo"></i> Réinitialiser tous les jeux
                            </button>
                            <button class="btn btn-outline-success" onclick="generateAllQRCodes()">
                                <i class="fas fa-qrcode"></i> Générer tous les QR codes
                            </button>
                        </div>
                    </div>
                </div>
