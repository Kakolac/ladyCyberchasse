                ...
                if ($equipe_parcours_id > 0) {
                    try {
                        ...
                        if ($stmt->execute([$equipe_parcours_id, $parcours_id])) {
                            ...
                            $error_message = "Erreur lors du retrait de l'équipe";
                        }
                    } catch (Exception $e) {
                        $error_message = "Erreur : " . $e->getMessage();
                    }
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card admin-card">
                <div class="card-header">
                    <h6><i class="fas fa-plus"></i> Ajouter un Lieu</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-8">
            <div class="card admin-card">
                <div class="card-header">
                    <h6><i class="fas fa-list"></i> Lieux du Parcours (<?php echo count($lieux_parcours); ?>)</h6>
                </div>
                <div class="card-body">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-4">
            <div class="card admin-card">
                <div class="card-header bg-success text-white">
                    <h6><i class="fas fa-users"></i> Assigner des Équipes</h6>
                </div>
                <div class="card-body">
                    <?php
        ...
        <div class="col-md-8">
            <div class="card admin-card">
                <div class="card-header bg-success text-white">
                    <h6><i class="fas fa-list"></i> Équipes du Parcours</h6>
                </div>
                <div class="card-body">
                    <?php
